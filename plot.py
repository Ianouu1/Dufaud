...
up_pi = ["data/Pi/scale_up_Pi_myLaptop_12x10e6.csv",
         "data/Pi/scale_up_Pi_myLaptop_12x10e7.csv",
         "data/Pi/scale_up_Pi_myLaptop_12x10e8.csv"]

out_pi = ["data/Pi/scale_out_Pi_myLaptop_12x10e6.csv",
          "data/Pi/scale_out_Pi_myLaptop_12x10e7.csv", ]

# Assignement 102
up_assignment102 = ["data/Assignment102/scale_up_Ass102_myLaptop_12x10e5.csv",
                    "data/Assignment102/scale_up_Ass102_myLaptop_12x10e6.csv",
                    "data/Assignment102/scale_up_Ass102_myLaptop_12x10e7.csv"]
out_assignment102 = ["data/Assignment102/scale_out_Ass102_myLaptop_12x10e6.csv",
                     "data/Assignment102/scale_out_Ass102_myLaptop_12x10e5.csv"]

# Master / Worker

up_MW = ["data/MasterWorker/scale_up_MW_myLaptop_12x10e6.csv",
         "data/MasterWorker/scale_up_MW_myLaptop_12x10e7.csv",
         "data/MasterWorker/scale_up_MW_myLaptop_12x10e8.csv"]

out_MW = ["data/MasterWorker/scale_out_MW_myLaptop_12x10e5.csv",
          "data/MasterWorker/scale_out_MW_myLaptop_12x10e6.csv",
          "data/MasterWorker/scale_out_MW_myLaptop_12x10e7.csv"]
